...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='choice',
            field=models.ManyToManyField(related_name='+', to='survey.questionchoicemodel', verbose_name='Answer (if choice)'),
        ),
        migrations.AddField(
            model_name='answermodel',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='survey.questionmodel', verbose_name='Question to which is answered'),
        ),
